...
public class PcaAlgorithm {
     ...
     *   reduced.  
     */
    public PcaAlgorithm(RealMatrix data, CovarianceType covType, double level) {
     ...
     *   data.
     */
    public PcaAlgorithm(RealMatrix data, CovarianceType covType, int indices) {
        if(data == null || covType == null) {
            throw new NullPointerException();
        }
    ...
    public PcaAlgorithm(RealMatrix data) {
